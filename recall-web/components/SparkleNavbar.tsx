...
const SparkleNavbar: React.FC<SparkleNavbarProps> = ({
  ...
  // Helper function to calculate horizontal offset for active element
            ...
            return (
              <li key={item} className={isActive ? 'active' : ''}>
                <button
                  ...
                  className={`text-xs sm:text-sm font-sans transition-all select-none cursor-pointer ${
                    isActive
                      ? 'text-[#0F172A] font-extrabold'
                      : 'text-slate-600 font-semibold hover:text-[#0F172A]'
                  }`}
                >
                  {item}
                </button>
